...
@dataclass
class LlamaABSAConfig:
    # Change model to a public one like RoBERTa or BERT
    model_name: str = "roberta-base"  # Changed from meta-llama/Llama-2-7b
    experiment_name: str = "roberta-absa-baseline"
    learning_rate: float = 1e-4
    batch_size: int = 16
    num_epochs: int = 20
    warmup_steps: int = 1000
